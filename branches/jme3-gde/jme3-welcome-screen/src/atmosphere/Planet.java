...
public class Planet {
    ...
    private void defaultValues() {
        ...
        // More test values for the record
//        Kr = 0.0030f;
//        Km = 0.0020f;
//        ESun = 10f;
//        exposure = 2f;
...
//        // good for testing earth mantaining proportional values
//        wavelength = new Vector3f(0.650f + (0.650f * 0.14f),
//                                  0.570f + (0.570f * 0.14f),
//                                  0.475f + (0.475f * 0.07f));

//        // These are Earth atmosphere color values but result too bright
