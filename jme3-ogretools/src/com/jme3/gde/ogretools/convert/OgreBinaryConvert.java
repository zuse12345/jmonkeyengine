...
public final class OgreBinaryConvert implements ActionListener {

    private final DataObject context;

    public OgreBinaryConvert(DataObject context) {
            ...
            Runnable run = new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if(model==null){
                            throw new UnknownError("could not convert model");
                        }
                        //export model
