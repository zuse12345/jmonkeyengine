 ...
 * The text shows the distance to the center of the scene. 
 * The icon is happy if close, and sad if fuhrter away from the center.
 */
public class SimpleUserInterface2 extends SimpleApplication {
    private static SimpleUserInterface2 app;   // The application object
