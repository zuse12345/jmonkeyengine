...
public class TestPhysicsCar extends SimpleBulletApplication implements ActionListener {
    ...
    private void buildPlayer() {
        ...
        //create vehicle node
        player = new PhysicsVehicleNode(new Node(), compoundShape, 800);
        ...
        player.addWheel(wheels1, new Vector3f(-xOff, yOff, zOff),
        ...
        player.addWheel(wheels2, new Vector3f(xOff, yOff, zOff),
                wheelDirection, wheelAxle, restLength, radius, true);
        ...
        player.addWheel(wheels3, new Vector3f(-xOff, yOff, -zOff),
        ...
        player.addWheel(wheels4, new Vector3f(xOff, yOff, -zOff),
                wheelDirection, wheelAxle, restLength, radius, false);
