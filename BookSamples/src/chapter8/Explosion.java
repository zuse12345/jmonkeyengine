...
public class Explosion extends SimpleApplication {
  ...
  private void createCrate() {
    Box b = new Box(Vector3f.ZERO, 1f,.5f,.3f);
    crate = new Geometry("crate", b);
    rootNode.attachChild(crate); 
    crate.setMaterial( (Material)assetManager.loadAsset( "Materials/bark.j3m") );
    
    /** A white ambient light source. */ 
    AmbientLight ambient = new AmbientLight();
    ambient.setColor(ColorRGBA.White);
    crate.addLight(ambient); 
  }
}
