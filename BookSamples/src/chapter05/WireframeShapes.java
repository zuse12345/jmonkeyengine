...
public class WireframeShapes extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        //Sphere mesh = new Sphere(16, 16, 1.0f);   // create sphere mesh
        //Sphere mesh = new Sphere(32, 16, 1.0f);   // create sphere mesh
        //Sphere mesh = new Sphere(16, 32, 1.0f);   // create sphere mesh
