...
//        shuriken.press("Down").notPress("Left", "Attack1").done();
//        shuriken.notPress("Left", "Down", "Attack1").done();
//        shuriken.press("Attack1").notPress("Down", "Left").done();
//        shuriken.notPress("Left", "Down", "Attack1").done();
    ...
    public void simpleUpdate(float tpf){
        ...
        shurikenText.setText(shurikenExec.getDebugString());

        fireballExec.updateExpiration(time);
        fireballText.setText(fireballExec.getDebugString());
    }
