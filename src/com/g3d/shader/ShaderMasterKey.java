...
public class ShaderMasterKey extends ContentKey {

    protected final String fragName;
    protected final DefineList defines;
    protected final String language;

    public ShaderMasterKey(String vertName, String fragName, DefineList defines, String lang){
        super(vertName);
    ...
    public boolean equals(Object obj) {
        ...
        final ShaderMasterKey other = (ShaderMasterKey) obj;
