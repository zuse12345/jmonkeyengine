 ...
 * The loaded files are stored in the project's assets directory,
 * e.g. under "Textures/chapter5/Teapot/Teapot.obj".
 */
public class WireframeModel extends SimpleApplication {
    ...
    public void simpleInitApp() {
        Geometry teapot = (Geometry) 
                //assetManager.loadModel("Textures/Teapot/Teapot.obj");
